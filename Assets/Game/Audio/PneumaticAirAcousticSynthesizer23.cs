...
{
    public class PneumaticAirAcousticSynthesizer23
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-023";
        public float PurgeHissFrequencyHz { get; set; } = 3295.0f;
