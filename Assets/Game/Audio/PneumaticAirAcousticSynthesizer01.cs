...
{
    public class PneumaticAirAcousticSynthesizer01
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-001";
        public float PurgeHissFrequencyHz { get; set; } = 1865.0f;
