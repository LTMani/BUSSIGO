...
{
    public class PneumaticAirAcousticSynthesizer29
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-029";
        public float PurgeHissFrequencyHz { get; set; } = 3685.0f;
