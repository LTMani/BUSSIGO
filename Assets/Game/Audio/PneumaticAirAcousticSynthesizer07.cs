...
{
    public class PneumaticAirAcousticSynthesizer07
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-007";
        public float PurgeHissFrequencyHz { get; set; } = 2255.0f;
