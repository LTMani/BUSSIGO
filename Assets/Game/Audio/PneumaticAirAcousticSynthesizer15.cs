...
{
    public class PneumaticAirAcousticSynthesizer15
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-015";
        public float PurgeHissFrequencyHz { get; set; } = 2775.0f;
        public float DecayTimeConstantSec { get; set; } = 0.59f;
