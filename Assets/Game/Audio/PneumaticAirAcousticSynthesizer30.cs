...
{
    public class PneumaticAirAcousticSynthesizer30
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-030";
        public float PurgeHissFrequencyHz { get; set; } = 3750.0f;
