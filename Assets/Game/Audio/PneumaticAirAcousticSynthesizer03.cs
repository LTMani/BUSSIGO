...
{
    public class PneumaticAirAcousticSynthesizer03
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-003";
        public float PurgeHissFrequencyHz { get; set; } = 1995.0f;
