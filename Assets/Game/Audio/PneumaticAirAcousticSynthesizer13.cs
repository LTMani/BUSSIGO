...
{
    public class PneumaticAirAcousticSynthesizer13
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-013";
        public float PurgeHissFrequencyHz { get; set; } = 2645.0f;
        public float DecayTimeConstantSec { get; set; } = 0.43f;
