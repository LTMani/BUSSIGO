...
{
    public class PneumaticAirAcousticSynthesizer25
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-025";
        public float PurgeHissFrequencyHz { get; set; } = 3425.0f;
