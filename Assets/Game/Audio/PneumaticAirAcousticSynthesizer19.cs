...
{
    public class PneumaticAirAcousticSynthesizer19
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-019";
        public float PurgeHissFrequencyHz { get; set; } = 3035.0f;
