...
{
    public class PneumaticAirAcousticSynthesizer22
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-022";
        public float PurgeHissFrequencyHz { get; set; } = 3230.0f;
