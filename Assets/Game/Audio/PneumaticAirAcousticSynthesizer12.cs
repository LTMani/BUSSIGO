...
{
    public class PneumaticAirAcousticSynthesizer12
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-012";
        public float PurgeHissFrequencyHz { get; set; } = 2580.0f;
