...
{
    public class PneumaticAirAcousticSynthesizer08
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-008";
        public float PurgeHissFrequencyHz { get; set; } = 2320.0f;
