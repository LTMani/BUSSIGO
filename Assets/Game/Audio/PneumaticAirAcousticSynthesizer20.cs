...
{
    public class PneumaticAirAcousticSynthesizer20
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-020";
        public float PurgeHissFrequencyHz { get; set; } = 3100.0f;
