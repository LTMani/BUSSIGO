...
{
    public class PneumaticAirAcousticSynthesizer10
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-010";
        public float PurgeHissFrequencyHz { get; set; } = 2450.0f;
