...
{
    public class PneumaticAirAcousticSynthesizer17
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-017";
        public float PurgeHissFrequencyHz { get; set; } = 2905.0f;
