...
{
    public class PneumaticAirAcousticSynthesizer11
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-011";
        public float PurgeHissFrequencyHz { get; set; } = 2515.0f;
