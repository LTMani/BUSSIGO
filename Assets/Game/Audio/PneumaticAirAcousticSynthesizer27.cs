...
{
    public class PneumaticAirAcousticSynthesizer27
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-027";
        public float PurgeHissFrequencyHz { get; set; } = 3555.0f;
