...
{
    public class PneumaticAirAcousticSynthesizer09
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-009";
        public float PurgeHissFrequencyHz { get; set; } = 2385.0f;
