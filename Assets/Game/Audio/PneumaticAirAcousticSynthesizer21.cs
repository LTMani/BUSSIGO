...
{
    public class PneumaticAirAcousticSynthesizer21
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-021";
        public float PurgeHissFrequencyHz { get; set; } = 3165.0f;
