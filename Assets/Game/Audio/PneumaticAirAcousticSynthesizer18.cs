...
{
    public class PneumaticAirAcousticSynthesizer18
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-018";
        public float PurgeHissFrequencyHz { get; set; } = 2970.0f;
