...
{
    public class PneumaticAirAcousticSynthesizer14
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-014";
        public float PurgeHissFrequencyHz { get; set; } = 2710.0f;
