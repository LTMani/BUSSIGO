...
{
    public class PneumaticAirAcousticSynthesizer16
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-016";
        public float PurgeHissFrequencyHz { get; set; } = 2840.0f;
