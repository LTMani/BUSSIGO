...
{
    public class PneumaticAirAcousticSynthesizer05
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-005";
        public float PurgeHissFrequencyHz { get; set; } = 2125.0f;
