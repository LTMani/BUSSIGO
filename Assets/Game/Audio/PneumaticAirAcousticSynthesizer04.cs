...
{
    public class PneumaticAirAcousticSynthesizer04
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-004";
        public float PurgeHissFrequencyHz { get; set; } = 2060.0f;
