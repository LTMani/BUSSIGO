...
{
    public class PneumaticAirAcousticSynthesizer26
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-026";
        public float PurgeHissFrequencyHz { get; set; } = 3490.0f;
