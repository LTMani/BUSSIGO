...
{
    public class PneumaticAirAcousticSynthesizer06
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-006";
        public float PurgeHissFrequencyHz { get; set; } = 2190.0f;
