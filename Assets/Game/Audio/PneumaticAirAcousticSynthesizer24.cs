...
{
    public class PneumaticAirAcousticSynthesizer24
    {
        public string AcousticChannelId => "AUDIO-PNEUMATIC-CHAN-024";
        public float PurgeHissFrequencyHz { get; set; } = 3360.0f;
