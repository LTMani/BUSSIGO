...
{
    public class LiveryDecalPlacementTransformModel33
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-033";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-0.60f, 1.50f, -3.60f);
        public Vector3D RotationEulerDegrees { get; set; } = new Vector3D(0f, 180.0f, 0f);
        public Vector2D ScaleMeters { get; set; } = new Vector2D(1.10f, 0.60f);
