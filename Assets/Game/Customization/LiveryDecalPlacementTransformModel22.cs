...
{
    public class LiveryDecalPlacementTransformModel22
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-022";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(0.60f, 1.90f, 3.40f);
