...
{
    public class LiveryDecalPlacementTransformModel03
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-003";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(1.80f, 1.50f, -0.80f);
