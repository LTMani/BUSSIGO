...
{
    public class LiveryDecalPlacementTransformModel38
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-038";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(0.60f, 2.30f, 3.40f);
