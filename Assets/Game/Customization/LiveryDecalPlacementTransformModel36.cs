...
{
    public class LiveryDecalPlacementTransformModel36
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-036";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-1.80f, 1.50f, 0.60f);
        public Vector3D RotationEulerDegrees { get; set; } = new Vector3D(0f, 0.0f, 0f);
        public Vector2D ScaleMeters { get; set; } = new Vector2D(0.80f, 0.60f);
