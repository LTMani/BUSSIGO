...
{
    public class LiveryDecalPlacementTransformModel40
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-040";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-1.80f, 1.90f, -5.00f);
