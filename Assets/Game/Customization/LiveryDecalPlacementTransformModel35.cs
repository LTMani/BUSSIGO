...
{
    public class LiveryDecalPlacementTransformModel35
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-035";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(1.80f, 2.30f, -0.80f);
