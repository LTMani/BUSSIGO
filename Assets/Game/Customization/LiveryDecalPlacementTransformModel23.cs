...
{
    public class LiveryDecalPlacementTransformModel23
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-023";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(1.80f, 2.30f, 4.80f);
        public Vector3D RotationEulerDegrees { get; set; } = new Vector3D(0f, 180.0f, 0f);
        public Vector2D ScaleMeters { get; set; } = new Vector2D(1.70f, 1.10f);
        public float LayerOpacity01 { get; set; } = 0.96f;
