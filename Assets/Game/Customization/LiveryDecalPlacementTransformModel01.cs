...
{
    public class LiveryDecalPlacementTransformModel01
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-001";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-0.60f, 1.90f, -3.60f);
