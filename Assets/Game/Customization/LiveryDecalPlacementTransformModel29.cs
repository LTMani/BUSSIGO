...
{
    public class LiveryDecalPlacementTransformModel29
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-029";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-0.60f, 2.30f, 2.00f);
