...
{
    public class LiveryDecalPlacementTransformModel19
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-019";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(1.80f, 1.90f, -0.80f);
