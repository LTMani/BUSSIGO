...
{
    public class LiveryDecalPlacementTransformModel24
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-024";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-1.80f, 1.50f, -5.00f);
