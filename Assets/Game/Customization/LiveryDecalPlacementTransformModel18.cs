...
{
    public class LiveryDecalPlacementTransformModel18
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-018";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(0.60f, 1.50f, -2.20f);
