...
{
    public class LiveryDecalPlacementTransformModel13
    {
        public string DecalAssetId => "DECAL-ART-SOUTH-013";
        public Vector3D PositionOffsetMeters { get; set; } = new Vector3D(-0.60f, 1.90f, 2.00f);
        public Vector3D RotationEulerDegrees { get; set; } = new Vector3D(0f, 180.0f, 0f);
        public Vector2D ScaleMeters { get; set; } = new Vector2D(1.10f, 0.85f);
