...
{
    public class HighwayInfrastructureSection18
    {
        public string SectionId => "HWY-SEC-AP-TEL-018";
        public float SectionLengthMeters { get; set; } = 3900.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 3.57f;
