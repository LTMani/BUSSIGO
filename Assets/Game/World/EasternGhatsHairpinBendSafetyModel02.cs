...
{
    public class EasternGhatsHairpinBendSafetyModel02
    {
        public string HairpinCurveId => "GHAT-HAIRPIN-HP-02";
        public float CurveRadiusMeters { get; set; } = 19.0f; // Tight mountain radius 14m to 28m
        public float SuperelevationBankingAngleDegrees { get; set; } = 7.9f;
        public float DownhillGradientPercent { get; set; } = 10.7f; // Steep 8.5% to 14% descent
