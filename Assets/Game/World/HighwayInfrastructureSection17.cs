...
{
    public class HighwayInfrastructureSection17
    {
        public string SectionId => "HWY-SEC-AP-TEL-017";
        public float SectionLengthMeters { get; set; } = 3750.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 2.22f;
