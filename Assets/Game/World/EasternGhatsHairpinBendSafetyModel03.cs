...
{
    public class EasternGhatsHairpinBendSafetyModel03
    {
        public string HairpinCurveId => "GHAT-HAIRPIN-HP-03";
        public float CurveRadiusMeters { get; set; } = 21.5f; // Tight mountain radius 14m to 28m
