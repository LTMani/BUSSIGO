...
{
    public class HighwayInfrastructureSection09
    {
        public string SectionId => "HWY-SEC-AP-TEL-009";
        public float SectionLengthMeters { get; set; } = 2550.0f;
        public int NumberOfLanes { get; set; } = 4;
        public float AsphaltFrictionCoefficient { get; set; } = 0.980f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -1.99f;
