...
{
    public class HighwayInfrastructureSection08
    {
        public string SectionId => "HWY-SEC-AP-TEL-008";
        public float SectionLengthMeters { get; set; } = 2400.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -0.26f;
