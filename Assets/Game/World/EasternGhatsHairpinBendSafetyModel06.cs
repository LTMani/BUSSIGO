...
{
    public class EasternGhatsHairpinBendSafetyModel06
    {
        public string HairpinCurveId => "GHAT-HAIRPIN-HP-06";
        ...
        public float DownhillGradientPercent { get; set; } = 9.6f; // Steep 8.5% to 14% descent
