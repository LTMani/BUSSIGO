...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel04
    {
        public string TerminalCode => "TERM-SOUTH-04";
        public string TerminalNameEnglish => "Major South Bus Station Hub 04";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 04";
        public int TotalPlatformBays { get; set; } = 56;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel04()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 04-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 04-{b:D2} ఎక్స్‌ప్రెస్",
