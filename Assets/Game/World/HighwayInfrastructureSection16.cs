...
{
    public class HighwayInfrastructureSection16
    {
        public string SectionId => "HWY-SEC-AP-TEL-016";
        public float SectionLengthMeters { get; set; } = 3600.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 0.52f;
