...
{
    public class HighwayInfrastructureSection26
    {
        public string SectionId => "HWY-SEC-AP-TEL-026";
        public float SectionLengthMeters { get; set; } = 5100.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -3.73f;
