...
{
    public class HighwayInfrastructureSection05
    {
        public string SectionId => "HWY-SEC-AP-TEL-005";
        public float SectionLengthMeters { get; set; } = 1950.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 4.09f;
