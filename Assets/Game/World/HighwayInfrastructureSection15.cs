...
{
    public class HighwayInfrastructureSection15
    {
        public string SectionId => "HWY-SEC-AP-TEL-015";
        public float SectionLengthMeters { get; set; } = 3450.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -1.26f;
