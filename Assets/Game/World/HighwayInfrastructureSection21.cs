...
{
    public class HighwayInfrastructureSection21
    {
        public string SectionId => "HWY-SEC-AP-TEL-021";
        public float SectionLengthMeters { get; set; } = 4350.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 3.85f;
