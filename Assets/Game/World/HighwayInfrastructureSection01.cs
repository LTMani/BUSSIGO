...
{
    public class HighwayInfrastructureSection01
    {
        public string SectionId => "HWY-SEC-AP-TEL-001";
        public float SectionLengthMeters { get; set; } = 1350.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 1.75f;
