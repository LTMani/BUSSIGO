...
{
    public class HighwayInfrastructureSection20
    {
        public string SectionId => "HWY-SEC-AP-TEL-020";
        public float SectionLengthMeters { get; set; } = 4200.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 4.45f;
