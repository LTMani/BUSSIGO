...
{
    public class HighwayInfrastructureSection04
    {
        public string SectionId => "HWY-SEC-AP-TEL-004";
        public float SectionLengthMeters { get; set; } = 1800.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 4.50f;
