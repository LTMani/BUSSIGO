...
{
    public class HighwayInfrastructureSection30
    {
        public string SectionId => "HWY-SEC-AP-TEL-030";
        public float SectionLengthMeters { get; set; } = 5700.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -2.41f;
