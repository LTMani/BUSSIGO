...
{
    public class HighwayInfrastructureSection03
    {
        public string SectionId => "HWY-SEC-AP-TEL-003";
        public float SectionLengthMeters { get; set; } = 1650.0f;
        public int NumberOfLanes { get; set; } = 4;
        public float AsphaltFrictionCoefficient { get; set; } = 0.965f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 4.19f;
