...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel05
    {
        public string TerminalCode => "TERM-SOUTH-05";
        public string TerminalNameEnglish => "Major South Bus Station Hub 05";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 05";
        public int TotalPlatformBays { get; set; } = 64;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel05()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 05-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 05-{b:D2} ఎక్స్‌ప్రెస్",
