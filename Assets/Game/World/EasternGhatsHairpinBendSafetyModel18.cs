...
{
    public class EasternGhatsHairpinBendSafetyModel18
    {
        public string HairpinCurveId => "GHAT-HAIRPIN-HP-18";
        public float CurveRadiusMeters { get; set; } = 14.0f; // Tight mountain radius 14m to 28m
        public float SuperelevationBankingAngleDegrees { get; set; } = 7.9f;
        public float DownhillGradientPercent { get; set; } = 11.8f; // Steep 8.5% to 14% descent
