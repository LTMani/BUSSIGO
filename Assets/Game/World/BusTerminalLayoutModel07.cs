...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel07
    {
        public string TerminalCode => "TERM-SOUTH-07";
        public string TerminalNameEnglish => "Major South Bus Station Hub 07";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 07";
        public int TotalPlatformBays { get; set; } = 32;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel07()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 07-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 07-{b:D2} ఎక్స్‌ప్రెస్",
