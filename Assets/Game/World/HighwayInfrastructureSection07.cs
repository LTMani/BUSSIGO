...
{
    public class HighwayInfrastructureSection07
    {
        public string SectionId => "HWY-SEC-AP-TEL-007";
        public float SectionLengthMeters { get; set; } = 2250.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 1.51f;
