...
{
    public class HighwayInfrastructureSection12
    {
        public string SectionId => "HWY-SEC-AP-TEL-012";
        public float SectionLengthMeters { get; set; } = 3000.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -4.48f;
