...
{
    public class HighwayInfrastructureSection06
    {
        public string SectionId => "HWY-SEC-AP-TEL-006";
        public float SectionLengthMeters { get; set; } = 2100.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 3.04f;
