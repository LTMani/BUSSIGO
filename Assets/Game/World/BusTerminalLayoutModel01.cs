...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel01
    {
        public string TerminalCode => "TERM-SOUTH-01";
        public string TerminalNameEnglish => "Major South Bus Station Hub 01";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 01";
        public int TotalPlatformBays { get; set; } = 32;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel01()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 01-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 01-{b:D2} ఎక్స్‌ప్రెస్",
