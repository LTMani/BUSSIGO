...
{
    public class HighwayInfrastructureSection29
    {
        public string SectionId => "HWY-SEC-AP-TEL-029";
        public float SectionLengthMeters { get; set; } = 5550.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -3.70f;
