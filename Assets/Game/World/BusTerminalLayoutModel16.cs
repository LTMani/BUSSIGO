...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel16
    {
        public string TerminalCode => "TERM-SOUTH-16";
        public string TerminalNameEnglish => "Major South Bus Station Hub 16";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 16";
        public int TotalPlatformBays { get; set; } = 56;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel16()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 16-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 16-{b:D2} ఎక్స్‌ప్రెస్",
