...
{
    public class HighwayInfrastructureSection19
    {
        public string SectionId => "HWY-SEC-AP-TEL-019";
        public float SectionLengthMeters { get; set; } = 4050.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 4.36f;
