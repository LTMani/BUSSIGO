...
namespace Bussigo.Game.World
{
    ...
    public class BusTerminalLayoutModel02
    {
        public string TerminalCode => "TERM-SOUTH-02";
        public string TerminalNameEnglish => "Major South Bus Station Hub 02";
        public string TerminalNameTelugu => "ప్రధాన బస్ స్టేషన్ కాంప్లెక్స్ 02";
        public int TotalPlatformBays { get; set; } = 40;
        public List<BusPlatformBay> Platforms { get; } = new List<BusPlatformBay>();

        public BusTerminalLayoutModel02()
        {
            for (int b = 1; b <= TotalPlatformBays; b++)
            {
                ...
                {
                    BayNumber = b,
                    DestinationSignboardEnglish = $"Platform 02-{b:D2} Express",
                    DestinationSignboardTelugu = $"ప్లాట్‌ఫారం 02-{b:D2} ఎక్స్‌ప్రెస్",
