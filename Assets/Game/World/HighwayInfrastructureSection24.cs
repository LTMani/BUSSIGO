...
{
    public class HighwayInfrastructureSection24
    {
        public string SectionId => "HWY-SEC-AP-TEL-024";
        public float SectionLengthMeters { get; set; } = 4800.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -0.78f;
