...
{
    public class HighwayInfrastructureSection02
    {
        public string SectionId => "HWY-SEC-AP-TEL-002";
        public float SectionLengthMeters { get; set; } = 1500.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 3.23f;
