...
{
    public class HighwayInfrastructureSection23
    {
        public string SectionId => "HWY-SEC-AP-TEL-023";
        public float SectionLengthMeters { get; set; } = 4650.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = 1.00f;
