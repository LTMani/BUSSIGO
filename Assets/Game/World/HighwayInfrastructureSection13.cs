...
{
    public class HighwayInfrastructureSection13
    {
        public string SectionId => "HWY-SEC-AP-TEL-013";
        public float SectionLengthMeters { get; set; } = 3150.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -3.98f;
