...
{
    public class HighwayInfrastructureSection14
    {
        public string SectionId => "HWY-SEC-AP-TEL-014";
        public float SectionLengthMeters { get; set; } = 3300.0f;
        ...
        public float RoadElevationGradientPercent { get; set; } = -2.84f;
