...
{
    public class DiagnosticScanSessionReport16
    {
    ...
    public class WorkshopOBDScannerDiagnosticService16
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-016";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport16 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport16
            {
