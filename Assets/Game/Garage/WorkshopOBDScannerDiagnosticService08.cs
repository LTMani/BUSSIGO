...
{
    public class DiagnosticScanSessionReport08
    {
    ...
    public class WorkshopOBDScannerDiagnosticService08
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-008";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport08 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport08
            {
