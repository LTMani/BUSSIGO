...
{
    public class DiagnosticScanSessionReport15
    {
    ...
    public class WorkshopOBDScannerDiagnosticService15
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-015";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport15 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport15
            {
