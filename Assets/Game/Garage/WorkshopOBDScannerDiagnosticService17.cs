...
{
    public class DiagnosticScanSessionReport17
    {
    ...
    public class WorkshopOBDScannerDiagnosticService17
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-017";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport17 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport17
            {
