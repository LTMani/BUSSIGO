...
{
    public class DiagnosticScanSessionReport12
    {
    ...
    public class WorkshopOBDScannerDiagnosticService12
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-012";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport12 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport12
            {
