...
{
    public class DiagnosticScanSessionReport06
    {
    ...
    public class WorkshopOBDScannerDiagnosticService06
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-006";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport06 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport06
            {
