...
{
    public class DiagnosticScanSessionReport07
    {
    ...
    public class WorkshopOBDScannerDiagnosticService07
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-007";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport07 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport07
            {
