...
{
    public class DiagnosticScanSessionReport09
    {
    ...
    public class WorkshopOBDScannerDiagnosticService09
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-009";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport09 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport09
            {
