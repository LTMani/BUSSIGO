...
{
    public class DiagnosticScanSessionReport23
    {
    ...
    public class WorkshopOBDScannerDiagnosticService23
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-023";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport23 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport23
            {
