...
{
    public class DiagnosticScanSessionReport03
    {
    ...
    public class WorkshopOBDScannerDiagnosticService03
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-003";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport03 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport03
            {
