...
{
    public class DiagnosticScanSessionReport01
    {
    ...
    public class WorkshopOBDScannerDiagnosticService01
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-001";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport01 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport01
            {
