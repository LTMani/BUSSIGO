...
{
    public class DiagnosticScanSessionReport20
    {
    ...
    public class WorkshopOBDScannerDiagnosticService20
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-020";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport20 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport20
            {
