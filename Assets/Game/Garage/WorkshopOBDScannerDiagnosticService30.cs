...
{
    public class DiagnosticScanSessionReport30
    {
    ...
    public class WorkshopOBDScannerDiagnosticService30
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-030";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport30 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport30
            {
