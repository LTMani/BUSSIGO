...
{
    public class DiagnosticScanSessionReport27
    {
    ...
    public class WorkshopOBDScannerDiagnosticService27
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-027";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport27 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport27
            {
