...
{
    public class DiagnosticScanSessionReport21
    {
    ...
    public class WorkshopOBDScannerDiagnosticService21
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-021";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport21 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport21
            {
