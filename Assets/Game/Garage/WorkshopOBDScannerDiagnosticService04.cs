...
{
    public class DiagnosticScanSessionReport04
    {
    ...
    public class WorkshopOBDScannerDiagnosticService04
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-004";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport04 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport04
            {
