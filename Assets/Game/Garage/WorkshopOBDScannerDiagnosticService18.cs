...
{
    public class DiagnosticScanSessionReport18
    {
    ...
    public class WorkshopOBDScannerDiagnosticService18
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-018";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport18 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport18
            {
