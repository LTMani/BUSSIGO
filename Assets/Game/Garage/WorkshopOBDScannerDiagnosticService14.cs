...
{
    public class DiagnosticScanSessionReport14
    {
    ...
    public class WorkshopOBDScannerDiagnosticService14
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-014";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport14 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport14
            {
