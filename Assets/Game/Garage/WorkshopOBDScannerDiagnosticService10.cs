...
{
    public class DiagnosticScanSessionReport10
    {
    ...
    public class WorkshopOBDScannerDiagnosticService10
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-010";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport10 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport10
            {
