...
{
    public class DiagnosticScanSessionReport29
    {
    ...
    public class WorkshopOBDScannerDiagnosticService29
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-029";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport29 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport29
            {
