...
{
    public class DiagnosticScanSessionReport26
    {
    ...
    public class WorkshopOBDScannerDiagnosticService26
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-026";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport26 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport26
            {
