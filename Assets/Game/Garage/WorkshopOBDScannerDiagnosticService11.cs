...
{
    public class DiagnosticScanSessionReport11
    {
    ...
    public class WorkshopOBDScannerDiagnosticService11
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-011";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport11 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport11
            {
