...
{
    public class DiagnosticScanSessionReport24
    {
    ...
    public class WorkshopOBDScannerDiagnosticService24
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-024";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport24 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport24
            {
