...
{
    public class DiagnosticScanSessionReport05
    {
    ...
    public class WorkshopOBDScannerDiagnosticService05
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-005";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport05 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport05
            {
