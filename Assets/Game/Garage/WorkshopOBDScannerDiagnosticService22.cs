...
{
    public class DiagnosticScanSessionReport22
    {
    ...
    public class WorkshopOBDScannerDiagnosticService22
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-022";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport22 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport22
            {
