...
{
    public class DiagnosticScanSessionReport25
    {
    ...
    public class WorkshopOBDScannerDiagnosticService25
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-025";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport25 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport25
            {
