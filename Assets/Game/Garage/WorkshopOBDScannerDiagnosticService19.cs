...
{
    public class DiagnosticScanSessionReport19
    {
    ...
    public class WorkshopOBDScannerDiagnosticService19
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-019";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport19 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport19
            {
