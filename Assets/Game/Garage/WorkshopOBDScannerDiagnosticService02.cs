...
{
    public class DiagnosticScanSessionReport02
    {
    ...
    public class WorkshopOBDScannerDiagnosticService02
    {
        public string ScannerSerialNumber => "BOSCH-COMMERCIAL-SCAN-002";
        public bool IsScannerConnected { get; private set; } = false;

        public DiagnosticScanSessionReport02 PerformFullSystemDiagnostics(VehicleWearSystem wear)
        {
            IsScannerConnected = true;
            var report = new DiagnosticScanSessionReport02
            {
