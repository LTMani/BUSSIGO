...
{
    public class ParcelCargoTariffCalculator08
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 7.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 360.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 60.0f;
