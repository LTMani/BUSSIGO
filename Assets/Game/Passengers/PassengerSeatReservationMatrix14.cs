...
{
    public class PassengerSeatReservationMatrix14
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-14";
        public int TotalSeatsCount { get; set; } = 38;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix14()
        {
