...
{
    public class ParcelCargoTariffCalculator15
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 10.50f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 570.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 95.0f;
