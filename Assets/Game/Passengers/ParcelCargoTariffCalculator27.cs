...
{
    public class ParcelCargoTariffCalculator27
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 15.30f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 930.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 155.0f;
