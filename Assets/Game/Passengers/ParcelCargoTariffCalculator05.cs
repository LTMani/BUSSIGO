...
{
    public class ParcelCargoTariffCalculator05
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 6.50f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 270.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 45.0f;
