...
{
    public class LuggageCompartmentLoadDistribution04
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-004";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 14.5f;
        public float MaxLuggageWeightCapacityKg { get; set; } = 1200.0f;
