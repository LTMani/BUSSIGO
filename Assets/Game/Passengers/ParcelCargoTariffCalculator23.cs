...
{
    public class ParcelCargoTariffCalculator23
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 13.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 810.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 135.0f;
