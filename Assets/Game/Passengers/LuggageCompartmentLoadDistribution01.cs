...
{
    public class LuggageCompartmentLoadDistribution01
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-001";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 10.0f;
        public float MaxLuggageWeightCapacityKg { get; set; } = 1450.0f;
