...
{
    public class LuggageCompartmentLoadDistribution13
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-013";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 13.0f;
