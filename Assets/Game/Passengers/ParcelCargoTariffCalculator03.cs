...
{
    public class ParcelCargoTariffCalculator03
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 5.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 210.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 35.0f;
