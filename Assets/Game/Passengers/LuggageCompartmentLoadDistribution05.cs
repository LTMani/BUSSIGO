...
{
    public class LuggageCompartmentLoadDistribution05
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-005";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 8.5f;
