...
{
    public class PassengerSeatReservationMatrix30
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-30";
        public int TotalSeatsCount { get; set; } = 42;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix30()
        {
