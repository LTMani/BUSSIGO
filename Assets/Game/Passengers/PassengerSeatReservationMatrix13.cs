...
namespace Bussigo.Game.Passengers
{
    ...
    public class PassengerSeatReservationMatrix13
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-013";
        public int TotalSeatsCount { get; set; } = 48;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix13()
        {
