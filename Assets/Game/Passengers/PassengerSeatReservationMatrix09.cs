...
{
    public class PassengerSeatReservationMatrix09
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-09";
        public int TotalSeatsCount { get; set; } = 45;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix09()
        {
