...
{
    public class PassengerSeatReservationMatrix17
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-17";
        public int TotalSeatsCount { get; set; } = 41;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix17()
        {
