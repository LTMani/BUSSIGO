...
{
    public class ParcelCargoTariffCalculator04
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 6.10f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 240.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 40.0f;
