...
{
    public class LuggageCompartmentLoadDistribution19
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-019";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 14.5f;
