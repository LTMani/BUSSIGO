...
{
    public class PassengerSeatReservationMatrix05
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-05";
        public int TotalSeatsCount { get; set; } = 41;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix05()
        {
