...
{
    public class ParcelCargoTariffCalculator13
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 9.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 510.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 85.0f;
