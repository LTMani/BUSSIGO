...
{
    public class PassengerSeatReservationMatrix21
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-21";
        public int TotalSeatsCount { get; set; } = 45;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix21()
        {
