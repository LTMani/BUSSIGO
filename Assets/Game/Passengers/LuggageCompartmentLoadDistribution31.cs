...
{
    public class LuggageCompartmentLoadDistribution31
    {
        public string CompartmentId => "LUGGAGE-BAY-SECTION-031";
        public float MaxLuggageVolumeCapacityM3 { get; set; } = 10.0f;
        public float MaxLuggageWeightCapacityKg { get; set; } = 1950.0f;
