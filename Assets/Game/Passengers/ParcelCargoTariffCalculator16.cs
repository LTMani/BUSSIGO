...
{
    public class ParcelCargoTariffCalculator16
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 10.90f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 600.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 100.0f;
