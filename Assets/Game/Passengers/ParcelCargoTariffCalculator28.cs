...
{
    public class ParcelCargoTariffCalculator28
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 15.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 960.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 160.0f;
