...
namespace Bussigo.Game.Passengers
{
    ...
    public class PassengerSeatReservationMatrix28
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-028";
        public int TotalSeatsCount { get; set; } = 48;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix28()
        {
