...
{
    public class PassengerSeatReservationMatrix11
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-11";
        public int TotalSeatsCount { get; set; } = 47;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix11()
        {
