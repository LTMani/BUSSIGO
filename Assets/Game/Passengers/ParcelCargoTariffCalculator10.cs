...
{
    public class ParcelCargoTariffCalculator10
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 8.50f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 420.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 70.0f;
