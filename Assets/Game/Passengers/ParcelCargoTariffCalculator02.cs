...
{
    public class ParcelCargoTariffCalculator02
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 5.30f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 180.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 30.0f;
