...
{
    public class PassengerSeatReservationMatrix25
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-25";
        public int TotalSeatsCount { get; set; } = 37;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix25()
        {
