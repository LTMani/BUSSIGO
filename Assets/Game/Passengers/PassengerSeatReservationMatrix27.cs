...
namespace Bussigo.Game.Passengers
{
    ...
    public class PassengerSeatReservationMatrix27
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-027";
        public int TotalSeatsCount { get; set; } = 44;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix27()
        {
