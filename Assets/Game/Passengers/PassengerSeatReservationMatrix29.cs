...
{
    public class PassengerSeatReservationMatrix29
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-29";
        public int TotalSeatsCount { get; set; } = 41;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix29()
        {
