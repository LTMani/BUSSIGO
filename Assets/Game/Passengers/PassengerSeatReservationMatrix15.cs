...
{
    public class PassengerSeatReservationMatrix15
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-15";
        public int TotalSeatsCount { get; set; } = 39;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix15()
        {
