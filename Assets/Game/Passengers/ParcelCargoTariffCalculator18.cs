...
{
    public class ParcelCargoTariffCalculator18
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 11.70f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 660.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 110.0f;
