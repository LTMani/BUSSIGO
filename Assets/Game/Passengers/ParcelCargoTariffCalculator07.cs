...
{
    public class ParcelCargoTariffCalculator07
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 7.30f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 330.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 55.0f;
