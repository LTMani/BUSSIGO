...
{
    public class PassengerSeatReservationMatrix20
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-20";
        public int TotalSeatsCount { get; set; } = 44;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix20()
        {
