...
namespace Bussigo.Game.Passengers
{
    ...
    public class PassengerSeatReservationMatrix08
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-008";
        public int TotalSeatsCount { get; set; } = 48;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix08()
        {
