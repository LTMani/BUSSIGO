...
namespace Bussigo.Game.Passengers
{
    ...
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 10.10f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 540.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 90.0f;
