...
{
    public class PassengerSeatReservationMatrix01
    {
        public string BusLayoutCode => "LAYOUT-CONFIG-01";
        public int TotalSeatsCount { get; set; } = 37;
        public List<SeatSlot> Seats { get; } = new List<SeatSlot>();

        public PassengerSeatReservationMatrix01()
        {
