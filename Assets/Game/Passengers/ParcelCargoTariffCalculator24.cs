...
{
    public class ParcelCargoTariffCalculator24
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 14.10f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 840.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 140.0f;
