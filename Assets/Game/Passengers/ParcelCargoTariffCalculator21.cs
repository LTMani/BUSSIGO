...
{
    public class ParcelCargoTariffCalculator21
    {
        public float BaseFreightRatePerKgPer100Km { get; set; } = 12.90f;
        public float MinimumFreightDocketChargeRupees { get; set; } = 750.0f;
        public float ExpressParcelSurchargePercent { get; set; } = 125.0f;
