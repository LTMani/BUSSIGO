...
{
    public class BusComponentWiringDiagram24
    {
        public string CircuitId => "CIRCUIT_SCHEMATIC_24";
        public float MainBusbarVoltage { get; set; } = 24.0f;
        public float FuseRatingAmps { get; set; } = 15.0f;
        public bool RelayStateClosed { get; set; } = true;
        public float ResistanceOhms { get; set; } = 1.65f;
