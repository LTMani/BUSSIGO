...
{
    public class CabinAirConditioningThermalModel04
    {
        public string HVACSystemId => "HVAC-SYS-DENSO-004";
        public float CoolingCapacityKilowatts { get; set; } = 44.0f; // Commercial bus AC unit 28kW to 48kW
        ...
        public float BlowerAirflowCfm { get; set; } = 2800.0f;
