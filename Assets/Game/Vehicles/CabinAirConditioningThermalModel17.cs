...
{
    public class CabinAirConditioningThermalModel17
    {
        public string HVACSystemId => "HVAC-SYS-DENSO-017";
        public float CoolingCapacityKilowatts { get; set; } = 48.0f; // Commercial bus AC unit 28kW to 48kW
