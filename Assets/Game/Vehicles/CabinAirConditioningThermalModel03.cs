...
{
    public class CabinAirConditioningThermalModel03
    {
        public string HVACSystemId => "HVAC-SYS-DENSO-003";
        public float CoolingCapacityKilowatts { get; set; } = 40.0f; // Commercial bus AC unit 28kW to 48kW
        ...
        public float BlowerAirflowCfm { get; set; } = 2550.0f;
