...
{
    public class CabinAirConditioningThermalModel24
    {
        public string HVACSystemId => "HVAC-SYS-DENSO-024";
        public float CoolingCapacityKilowatts { get; set; } = 28.0f; // Commercial bus AC unit 28kW to 48kW
