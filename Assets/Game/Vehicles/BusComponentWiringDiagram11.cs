...
{
    public class BusComponentWiringDiagram11
    {
        public string CircuitId => "CIRCUIT_SCHEMATIC_11";
        public float MainBusbarVoltage { get; set; } = 24.0f;
        public float FuseRatingAmps { get; set; } = 40.0f;
        public bool RelayStateClosed { get; set; } = true;
        public float ResistanceOhms { get; set; } = 1.00f;
