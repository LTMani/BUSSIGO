...
{
    public class BusComponentWiringDiagram04
    {
        public string CircuitId => "CIRCUIT_SCHEMATIC_04";
        public float MainBusbarVoltage { get; set; } = 24.0f;
        public float FuseRatingAmps { get; set; } = 35.0f;
        public bool RelayStateClosed { get; set; } = true;
        public float ResistanceOhms { get; set; } = 0.65f;
