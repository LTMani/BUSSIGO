...
{
    public class CabinAirConditioningThermalModel20
    {
        public string HVACSystemId => "HVAC-SYS-DENSO-020";
        public float CoolingCapacityKilowatts { get; set; } = 36.0f; // Commercial bus AC unit 28kW to 48kW
