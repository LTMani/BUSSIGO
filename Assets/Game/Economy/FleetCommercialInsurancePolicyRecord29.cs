...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord29
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0029";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(1);
        public float AnnualPremiumRupees { get; set; } = 74500.00f;
        public float SumInsuredRupees { get; set; } = 14650000.00f;
