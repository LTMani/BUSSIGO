...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord26
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0026";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(2);
        public float AnnualPremiumRupees { get; set; } = 55000.00f;
        public float SumInsuredRupees { get; set; } = 13600000.00f;
