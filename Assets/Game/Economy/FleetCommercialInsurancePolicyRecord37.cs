...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord37
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0037";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(1);
        public float AnnualPremiumRupees { get; set; } = 48500.00f;
        public float SumInsuredRupees { get; set; } = 17450000.00f;
