...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord40
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0040";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(0);
        public float AnnualPremiumRupees { get; set; } = 68000.00f;
        public float SumInsuredRupees { get; set; } = 18500000.00f;
