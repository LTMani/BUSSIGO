...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord38
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0038";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(2);
        public float AnnualPremiumRupees { get; set; } = 55000.00f;
        public float SumInsuredRupees { get; set; } = 17800000.00f;
