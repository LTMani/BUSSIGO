...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord17
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0017";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(1);
        public float AnnualPremiumRupees { get; set; } = 74500.00f;
        public float SumInsuredRupees { get; set; } = 10450000.00f;
