...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord39
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0039";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(3);
        public float AnnualPremiumRupees { get; set; } = 61500.00f;
        public float SumInsuredRupees { get; set; } = 18150000.00f;
