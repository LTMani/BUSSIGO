...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord36
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0036";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(0);
        public float AnnualPremiumRupees { get; set; } = 42000.00f;
        public float SumInsuredRupees { get; set; } = 17100000.00f;
