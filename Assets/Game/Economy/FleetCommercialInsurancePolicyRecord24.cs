...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord24
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0024";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(0);
        public float AnnualPremiumRupees { get; set; } = 42000.00f;
        public float SumInsuredRupees { get; set; } = 12900000.00f;
