...
namespace Bussigo.Game.Economy
{
    ...
    public class BankLoanAmortizationSchedule06
    {
        public string LoanAgreementNumber => "LOAN-AGR-SBI-006";
        public float PrincipalAmountRupees { get; set; } = 4500000.00f;
        public float AnnualInterestRatePercent { get; set; } = 9.75f;
        public int LoanTenureMonths { get; set; } = 36;
