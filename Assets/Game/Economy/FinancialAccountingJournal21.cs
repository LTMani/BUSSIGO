...
namespace Bussigo.Game.Economy
{
    ...
    public class FinancialAccountingJournal21
    {
        public string JournalVoucherNumber => "JV-BUSSIGO-0021";
        public DateTime VoucherDate { get; set; } = DateTime.UtcNow;
        public string Narration { get; set; } = "Operating route fare revenue and highway toll settlement 21";
