...
namespace Bussigo.Game.Economy
{
    ...
    public class FleetCommercialInsurancePolicyRecord23
    {
        public string PolicyNumber => "POL-ICICI-LOMBARD-0023";
        public InsuranceCoverageType Coverage { get; set; } = (InsuranceCoverageType)(3);
        public float AnnualPremiumRupees { get; set; } = 74500.00f;
        public float SumInsuredRupees { get; set; } = 12550000.00f;
