...
namespace Bussigo.Game.Economy
{
    ...
    public class FinancialAccountingJournal09
    {
        public string JournalVoucherNumber => "JV-BUSSIGO-0009";
        public DateTime VoucherDate { get; set; } = DateTime.UtcNow;
        public string Narration { get; set; } = "Operating route fare revenue and highway toll settlement 09";
