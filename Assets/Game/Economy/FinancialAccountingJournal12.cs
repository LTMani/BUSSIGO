...
namespace Bussigo.Game.Economy
{
    ...
    public class FinancialAccountingJournal12
    {
        public string JournalVoucherNumber => "JV-BUSSIGO-0012";
        public DateTime VoucherDate { get; set; } = DateTime.UtcNow;
        public string Narration { get; set; } = "Operating route fare revenue and highway toll settlement 12";
