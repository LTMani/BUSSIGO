...
{
    public class ViewModelScreenPresenter21
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_21";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 21 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
