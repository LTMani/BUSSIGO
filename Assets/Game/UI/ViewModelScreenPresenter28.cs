...
{
    public class ViewModelScreenPresenter28
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_28";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 28 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
