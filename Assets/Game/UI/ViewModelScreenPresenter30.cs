...
{
    public class ViewModelScreenPresenter30
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_30";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 30 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
