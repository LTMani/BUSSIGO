...
{
    public class ViewModelScreenPresenter20
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_20";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 20 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
