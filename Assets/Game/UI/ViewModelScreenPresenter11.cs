...
{
    public class ViewModelScreenPresenter11
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_11";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 11 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
