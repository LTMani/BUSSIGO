...
{
    public class ViewModelScreenPresenter16
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_16";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 16 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
