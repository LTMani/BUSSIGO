...
{
    public class ViewModelScreenPresenter07
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_07";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 07 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
