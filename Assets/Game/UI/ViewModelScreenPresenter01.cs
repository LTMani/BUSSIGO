...
{
    public class ViewModelScreenPresenter01
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_01";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 01 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
