...
{
    public class ViewModelScreenPresenter05
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_05";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 05 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
