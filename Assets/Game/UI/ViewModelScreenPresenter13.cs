...
{
    public class ViewModelScreenPresenter13
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_13";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 13 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
