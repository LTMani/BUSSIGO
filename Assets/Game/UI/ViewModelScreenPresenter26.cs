...
{
    public class ViewModelScreenPresenter26
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_26";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 26 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
