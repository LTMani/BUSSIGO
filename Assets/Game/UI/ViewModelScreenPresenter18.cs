...
{
    public class ViewModelScreenPresenter18
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_18";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 18 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
