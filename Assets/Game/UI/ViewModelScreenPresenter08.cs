...
{
    public class ViewModelScreenPresenter08
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_08";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 08 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
