...
{
    public class ViewModelScreenPresenter04
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_04";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 04 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
