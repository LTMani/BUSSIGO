...
{
    public class ViewModelScreenPresenter14
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_14";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 14 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
