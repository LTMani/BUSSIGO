...
{
    public class ViewModelScreenPresenter02
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_02";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 02 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
