...
{
    public class ViewModelScreenPresenter15
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_15";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 15 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
