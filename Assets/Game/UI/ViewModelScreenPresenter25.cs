...
{
    public class ViewModelScreenPresenter25
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_25";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 25 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
