...
{
    public class ViewModelScreenPresenter17
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_17";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 17 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
