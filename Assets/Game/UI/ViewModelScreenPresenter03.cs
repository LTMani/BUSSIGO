...
{
    public class ViewModelScreenPresenter03
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_03";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 03 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
