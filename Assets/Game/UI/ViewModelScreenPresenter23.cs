...
{
    public class ViewModelScreenPresenter23
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_23";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 23 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
