...
{
    public class ViewModelScreenPresenter12
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_12";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 12 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
