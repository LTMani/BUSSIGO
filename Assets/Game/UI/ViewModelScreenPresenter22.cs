...
{
    public class ViewModelScreenPresenter22
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_22";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 22 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
