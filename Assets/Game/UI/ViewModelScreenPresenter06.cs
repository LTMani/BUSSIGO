...
{
    public class ViewModelScreenPresenter06
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_06";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 06 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
