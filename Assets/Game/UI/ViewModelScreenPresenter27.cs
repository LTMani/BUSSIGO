...
{
    public class ViewModelScreenPresenter27
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_27";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 27 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
