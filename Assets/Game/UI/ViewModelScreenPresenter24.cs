...
{
    public class ViewModelScreenPresenter24
    {
        public string ScreenIdentifier => "UI_SCREEN_PRESENTER_24";
        ...
        public void InitializePresenter()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                DisplayItems.Add($"Screen 24 Dashboard Element {i:D2} - Telemetry Slot Validated");
            }
        }
