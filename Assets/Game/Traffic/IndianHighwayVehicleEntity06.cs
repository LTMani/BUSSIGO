...
{
    public class IndianHighwayVehicleEntity06
    {
        public int VehicleInstanceId { get; set; } = 1006;
        ...
        public float DistanceToLeaderMeters { get; set; } = 63.0f;

        public IndianHighwayVehicleEntity06()
        {
