...
{
    public class IndianHighwayVehicleEntity25
    {
        public int VehicleInstanceId { get; set; } = 1025;
        ...
        public float DistanceToLeaderMeters { get; set; } = 120.0f;

        public IndianHighwayVehicleEntity25()
        {
