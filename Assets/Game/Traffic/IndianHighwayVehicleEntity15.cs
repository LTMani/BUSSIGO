...
{
    public class IndianHighwayVehicleEntity15
    {
        public int VehicleInstanceId { get; set; } = 1015;
        ...
        public float DistanceToLeaderMeters { get; set; } = 90.0f;

        public IndianHighwayVehicleEntity15()
        {
