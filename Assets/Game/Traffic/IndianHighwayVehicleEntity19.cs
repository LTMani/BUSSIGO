...
{
    public class IndianHighwayVehicleEntity19
    {
        public int VehicleInstanceId { get; set; } = 1019;
        ...
        public float DistanceToLeaderMeters { get; set; } = 102.0f;

        public IndianHighwayVehicleEntity19()
        {
