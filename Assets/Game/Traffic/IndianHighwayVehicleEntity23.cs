...
{
    public class IndianHighwayVehicleEntity23
    {
        public int VehicleInstanceId { get; set; } = 1023;
        ...
        public float DistanceToLeaderMeters { get; set; } = 114.0f;

        public IndianHighwayVehicleEntity23()
        {
