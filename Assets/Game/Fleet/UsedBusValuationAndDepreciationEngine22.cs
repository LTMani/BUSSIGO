...
{
    public class UsedBusValuationAndDepreciationEngine22
    {
        public string ValuationModelId => "VALUATION-MODEL-022";
        public float AnnualDepreciationRatePercent { get; set; } = 15.5f;
