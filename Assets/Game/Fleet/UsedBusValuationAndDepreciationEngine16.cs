...
{
    public class UsedBusValuationAndDepreciationEngine16
    {
        public string ValuationModelId => "VALUATION-MODEL-016";
        public float AnnualDepreciationRatePercent { get; set; } = 12.5f;
