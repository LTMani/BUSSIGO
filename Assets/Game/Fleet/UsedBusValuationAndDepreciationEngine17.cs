...
{
    public class UsedBusValuationAndDepreciationEngine17
    {
        public string ValuationModelId => "VALUATION-MODEL-017";
        public float AnnualDepreciationRatePercent { get; set; } = 14.0f;
