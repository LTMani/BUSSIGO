...
{
    public class SyntheticBillingTransactionRecord35
    {
        public string TransactionToken => "SYNTH-TX-STORE-0035";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_35";
        public long CoinsGrantedAmount { get; set; } = 975000;
