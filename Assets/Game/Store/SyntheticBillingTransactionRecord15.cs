...
{
    public class SyntheticBillingTransactionRecord15
    {
        public string TransactionToken => "SYNTH-TX-STORE-0015";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_15";
        public long CoinsGrantedAmount { get; set; } = 475000;
