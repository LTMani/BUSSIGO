...
{
    public class SyntheticBillingTransactionRecord25
    {
        public string TransactionToken => "SYNTH-TX-STORE-0025";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_25";
        public long CoinsGrantedAmount { get; set; } = 725000;
