...
{
    public class SyntheticBillingTransactionRecord26
    {
        public string TransactionToken => "SYNTH-TX-STORE-0026";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_26";
        public long CoinsGrantedAmount { get; set; } = 750000;
