...
{
    public class SyntheticBillingTransactionRecord24
    {
        public string TransactionToken => "SYNTH-TX-STORE-0024";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_24";
        public long CoinsGrantedAmount { get; set; } = 700000;
