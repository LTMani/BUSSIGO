...
{
    public class SyntheticBillingTransactionRecord28
    {
        public string TransactionToken => "SYNTH-TX-STORE-0028";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_28";
        public long CoinsGrantedAmount { get; set; } = 800000;
