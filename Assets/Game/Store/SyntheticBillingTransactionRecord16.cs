...
{
    public class SyntheticBillingTransactionRecord16
    {
        public string TransactionToken => "SYNTH-TX-STORE-0016";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_16";
        public long CoinsGrantedAmount { get; set; } = 500000;
