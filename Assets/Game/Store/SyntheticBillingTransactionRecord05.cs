...
{
    public class SyntheticBillingTransactionRecord05
    {
        public string TransactionToken => "SYNTH-TX-STORE-0005";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_05";
        public long CoinsGrantedAmount { get; set; } = 225000;
