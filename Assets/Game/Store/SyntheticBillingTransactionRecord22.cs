...
{
    public class SyntheticBillingTransactionRecord22
    {
        public string TransactionToken => "SYNTH-TX-STORE-0022";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_22";
        public long CoinsGrantedAmount { get; set; } = 650000;
