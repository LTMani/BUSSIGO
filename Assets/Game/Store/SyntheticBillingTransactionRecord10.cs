...
{
    public class SyntheticBillingTransactionRecord10
    {
        public string TransactionToken => "SYNTH-TX-STORE-0010";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_10";
        public long CoinsGrantedAmount { get; set; } = 350000;
