...
{
    public class SyntheticBillingTransactionRecord14
    {
        public string TransactionToken => "SYNTH-TX-STORE-0014";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_14";
        public long CoinsGrantedAmount { get; set; } = 450000;
