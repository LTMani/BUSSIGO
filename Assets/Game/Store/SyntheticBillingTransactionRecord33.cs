...
{
    public class SyntheticBillingTransactionRecord33
    {
        public string TransactionToken => "SYNTH-TX-STORE-0033";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_33";
        public long CoinsGrantedAmount { get; set; } = 925000;
