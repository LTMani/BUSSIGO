...
{
    public class SyntheticBillingTransactionRecord37
    {
        public string TransactionToken => "SYNTH-TX-STORE-0037";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_37";
        public long CoinsGrantedAmount { get; set; } = 1025000;
