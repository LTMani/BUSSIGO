...
{
    public class SyntheticBillingTransactionRecord40
    {
        public string TransactionToken => "SYNTH-TX-STORE-0040";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_40";
        public long CoinsGrantedAmount { get; set; } = 1100000;
