...
{
    public class SyntheticBillingTransactionRecord20
    {
        public string TransactionToken => "SYNTH-TX-STORE-0020";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_20";
        public long CoinsGrantedAmount { get; set; } = 600000;
