...
{
    public class SyntheticBillingTransactionRecord29
    {
        public string TransactionToken => "SYNTH-TX-STORE-0029";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_29";
        public long CoinsGrantedAmount { get; set; } = 825000;
