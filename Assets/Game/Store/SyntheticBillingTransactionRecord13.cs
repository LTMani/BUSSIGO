...
{
    public class SyntheticBillingTransactionRecord13
    {
        public string TransactionToken => "SYNTH-TX-STORE-0013";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_13";
        public long CoinsGrantedAmount { get; set; } = 425000;
