...
{
    public class SyntheticBillingTransactionRecord34
    {
        public string TransactionToken => "SYNTH-TX-STORE-0034";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_34";
        public long CoinsGrantedAmount { get; set; } = 950000;
