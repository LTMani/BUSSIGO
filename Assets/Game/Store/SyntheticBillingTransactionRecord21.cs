...
{
    public class SyntheticBillingTransactionRecord21
    {
        public string TransactionToken => "SYNTH-TX-STORE-0021";
        public string PackageSku { get; set; } = "SKU_COINS_BUNDLE_21";
        public long CoinsGrantedAmount { get; set; } = 625000;
