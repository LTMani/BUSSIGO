...
{
    public class CommercialDriverLicenseExamModel24
    {
        public string ExamCode => "RTO-EXAM-AP-TEL-024";
        public LicenseTier TargetLicenseTier { get; set; } = (LicenseTier)(0);
        public int RequiredDriverLevel { get; set; } = 5;
