...
{
    public class TropicalPuddleHydrodynamicsSolver07
    {
        public string DrainageZoneId => "DRAINAGE-ZONE-AP-007";
        public float StandingWaterDepthMm { get; private set; } = 0.0f;
        public float MaxPuddleDepthCapacityMm { get; set; } = 41.0f;
        public float CrossSlopeDrainageRateMmPerMin { get; set; } = 19.5f;
