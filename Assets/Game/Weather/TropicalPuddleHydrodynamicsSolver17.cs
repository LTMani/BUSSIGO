...
{
    public class TropicalPuddleHydrodynamicsSolver17
    {
        public string DrainageZoneId => "DRAINAGE-ZONE-AP-017";
        public float StandingWaterDepthMm { get; private set; } = 0.0f;
        public float MaxPuddleDepthCapacityMm { get; set; } = 41.0f;
        public float CrossSlopeDrainageRateMmPerMin { get; set; } = 14.5f;
