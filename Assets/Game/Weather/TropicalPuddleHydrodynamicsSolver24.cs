...
{
    public class TropicalPuddleHydrodynamicsSolver24
    {
        public string DrainageZoneId => "DRAINAGE-ZONE-AP-024";
        public float StandingWaterDepthMm { get; private set; } = 0.0f;
        public float MaxPuddleDepthCapacityMm { get; set; } = 57.0f;
        public float CrossSlopeDrainageRateMmPerMin { get; set; } = 12.0f;
