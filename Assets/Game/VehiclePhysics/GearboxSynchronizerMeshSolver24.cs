...
{
    public class GearboxSynchronizerMeshSolver24
    {
        public string GearboxCode => "GBX-HEAVY-SYNCHRO-024";
        public float ConeFrictionCoefficient { get; set; } = 0.095f;
        public float ShiftForkForceNewtons { get; set; } = 650.0f;
