...
{
    public class RegionalDepotFacilityController21
    {
        public string FacilityId => "DEPOT-FACILITY-AP-021";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 21";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 130000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 85700.0f;
        public int MaximumBusStablingCapacity { get; set; } = 22;
