...
{
    public class RegionalDepotFacilityController02
    {
        public string FacilityId => "DEPOT-FACILITY-AP-002";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 02";
        public int TotalWorkshopBays { get; set; } = 8;
        public float FuelStorageTankCapacityLiters { get; set; } = 35000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 24900.0f;
