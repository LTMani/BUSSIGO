...
{
    public class RegionalDepotFacilityController24
    {
        public string FacilityId => "DEPOT-FACILITY-AP-024";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 24";
        public int TotalWorkshopBays { get; set; } = 4;
        public float FuelStorageTankCapacityLiters { get; set; } = 145000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 95300.0f;
