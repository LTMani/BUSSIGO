...
{
    public class RegionalDepotFacilityController01
    {
        public string FacilityId => "DEPOT-FACILITY-AP-001";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 01";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 30000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 21700.0f;
