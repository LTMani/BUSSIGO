...
{
    public class RegionalDepotFacilityController17
    {
        public string FacilityId => "DEPOT-FACILITY-AP-017";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 17";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 110000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 72900.0f;
