...
{
    public class RegionalDepotFacilityController11
    {
        public string FacilityId => "DEPOT-FACILITY-AP-011";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 11";
        public int TotalWorkshopBays { get; set; } = 10;
        public float FuelStorageTankCapacityLiters { get; set; } = 80000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 53700.0f;
