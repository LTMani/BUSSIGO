...
namespace Bussigo.Game.Company
{
    ...
    public class StaffRosterProfileRecord12
    {
        public string EmployeeId => "EMP-SOUTH-012";
        public string FullName { get; set; } = "Transport Staff Member 12";
        ...
        public float SafetyRatingStars { get; set; } = 4.70f;
