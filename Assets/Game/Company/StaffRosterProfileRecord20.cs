...
namespace Bussigo.Game.Company
{
    ...
    public class StaffRosterProfileRecord20
    {
        public string EmployeeId => "EMP-SOUTH-020";
        public string FullName { get; set; } = "Transport Staff Member 20";
        public StaffRole Role { get; set; } = (StaffRole)(2);
        public float MonthlySalaryRupees { get; set; } = 42000.00f;
        public float FatigueLevel01 { get; set; } = 0.15f;
        public float SafetyRatingStars { get; set; } = 4.80f;
        public float FuelEfficiencySkill01 { get; set; } = 0.75f;
