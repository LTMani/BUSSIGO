...
{
    public class RegionalDepotFacilityController10
    {
        public string FacilityId => "DEPOT-FACILITY-AP-010";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 10";
        public int TotalWorkshopBays { get; set; } = 8;
        public float FuelStorageTankCapacityLiters { get; set; } = 75000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 50500.0f;
