...
{
    public class RegionalDepotFacilityController09
    {
        public string FacilityId => "DEPOT-FACILITY-AP-009";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 09";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 70000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 47300.0f;
