...
namespace Bussigo.Game.Company
{
    ...
    public class StaffRosterProfileRecord10
    {
        public string EmployeeId => "EMP-SOUTH-010";
        public string FullName { get; set; } = "Transport Staff Member 10";
        public StaffRole Role { get; set; } = (StaffRole)(4);
        public float MonthlySalaryRupees { get; set; } = 35000.00f;
