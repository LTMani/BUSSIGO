...
{
    public class RegionalDepotFacilityController07
    {
        public string FacilityId => "DEPOT-FACILITY-AP-007";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 07";
        public int TotalWorkshopBays { get; set; } = 10;
        public float FuelStorageTankCapacityLiters { get; set; } = 60000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 40900.0f;
