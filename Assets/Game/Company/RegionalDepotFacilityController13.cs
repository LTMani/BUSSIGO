...
{
    public class RegionalDepotFacilityController13
    {
        public string FacilityId => "DEPOT-FACILITY-AP-013";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 13";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 90000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 60100.0f;
        public int MaximumBusStablingCapacity { get; set; } = 34;
