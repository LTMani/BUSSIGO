...
{
    public class RegionalDepotFacilityController23
    {
        public string FacilityId => "DEPOT-FACILITY-AP-023";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 23";
        public int TotalWorkshopBays { get; set; } = 10;
        public float FuelStorageTankCapacityLiters { get; set; } = 140000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 92100.0f;
