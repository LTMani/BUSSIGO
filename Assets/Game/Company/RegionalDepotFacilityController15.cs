...
{
    public class RegionalDepotFacilityController15
    {
        public string FacilityId => "DEPOT-FACILITY-AP-015";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 15";
        public int TotalWorkshopBays { get; set; } = 10;
        public float FuelStorageTankCapacityLiters { get; set; } = 100000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 66500.0f;
