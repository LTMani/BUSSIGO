...
{
    public class RegionalDepotFacilityController14
    {
        public string FacilityId => "DEPOT-FACILITY-AP-014";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 14";
        public int TotalWorkshopBays { get; set; } = 8;
        public float FuelStorageTankCapacityLiters { get; set; } = 95000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 63300.0f;
