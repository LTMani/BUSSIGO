...
namespace Bussigo.Game.Company
{
    ...
    public class StaffRosterProfileRecord15
    {
        public string EmployeeId => "EMP-SOUTH-015";
        public string FullName { get; set; } = "Transport Staff Member 15";
        public StaffRole Role { get; set; } = (StaffRole)(3);
        public float MonthlySalaryRupees { get; set; } = 52500.00f;
