...
{
    public class RegionalDepotFacilityController06
    {
        public string FacilityId => "DEPOT-FACILITY-AP-006";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 06";
        public int TotalWorkshopBays { get; set; } = 8;
        public float FuelStorageTankCapacityLiters { get; set; } = 55000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 37700.0f;
