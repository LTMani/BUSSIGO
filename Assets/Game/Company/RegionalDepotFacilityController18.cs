...
{
    public class RegionalDepotFacilityController18
    {
        public string FacilityId => "DEPOT-FACILITY-AP-018";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 18";
        public int TotalWorkshopBays { get; set; } = 8;
        public float FuelStorageTankCapacityLiters { get; set; } = 115000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 76100.0f;
