...
{
    public class RegionalDepotFacilityController03
    {
        public string FacilityId => "DEPOT-FACILITY-AP-003";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 03";
        public int TotalWorkshopBays { get; set; } = 10;
        public float FuelStorageTankCapacityLiters { get; set; } = 40000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 28100.0f;
