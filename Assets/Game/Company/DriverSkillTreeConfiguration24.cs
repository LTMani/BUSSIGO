...
{
    public class DriverSkillTreeConfiguration24
    {
        public string SkillTreeId => "SKILL-TREE-DRIVER-024";
        public int EcoDrivingHypermilingLevel { get; set; } = 5;
        public int MountainGhatRoadMasteryLevel { get; set; } = 1;
        public int PunctualityExpressNavigatorLevel { get; set; } = 2;
        public int PassengerCareCustomerServiceLevel { get; set; } = 3;
