...
{
    public class RegionalDepotFacilityController04
    {
        public string FacilityId => "DEPOT-FACILITY-AP-004";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 04";
        public int TotalWorkshopBays { get; set; } = 4;
        public float FuelStorageTankCapacityLiters { get; set; } = 45000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 31300.0f;
