...
{
    public class RegionalDepotFacilityController05
    {
        public string FacilityId => "DEPOT-FACILITY-AP-005";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 05";
        public int TotalWorkshopBays { get; set; } = 6;
        public float FuelStorageTankCapacityLiters { get; set; } = 50000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 34500.0f;
