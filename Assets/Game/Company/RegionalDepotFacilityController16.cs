...
{
    public class RegionalDepotFacilityController16
    {
        public string FacilityId => "DEPOT-FACILITY-AP-016";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 16";
        public int TotalWorkshopBays { get; set; } = 4;
        public float FuelStorageTankCapacityLiters { get; set; } = 105000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 69700.0f;
