...
{
    public class RegionalDepotFacilityController08
    {
        public string FacilityId => "DEPOT-FACILITY-AP-008";
        public string DepotLocationName { get; set; } = "South Central Depot Hub 08";
        public int TotalWorkshopBays { get; set; } = 4;
        public float FuelStorageTankCapacityLiters { get; set; } = 65000.0f;
        public float CurrentFuelStorageLiters { get; set; } = 44100.0f;
